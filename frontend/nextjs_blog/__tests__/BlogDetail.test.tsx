...
describe('Blog Detail Page Test Cases', () => {
  it('Should render detail blog page of Id 1', async () => {
  ...
  it('Should render detail blog page of Id 2', async () => {
    const { page } = await getPage({
      route: '/posts/2',
    })
    render(page)
  ...
  it('Should back blog-page from detail blog page by clicking btn', async () => {
    const { page } = await getPage({
      route: '/posts/2',
    })
    render(page)
